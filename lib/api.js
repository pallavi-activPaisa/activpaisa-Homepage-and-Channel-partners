...
export async function verifyGST(userId, token, gstNumber) {
  const res = await fetch(`${BASE_URL}/partners/${userId}/gst/verify`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
...
export async function updateBusinessProfile(userId, token, businessData) {
  const res = await fetch(`${BASE_URL}/partners/${userId}/profile/business`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
      Accept: "application/json",
