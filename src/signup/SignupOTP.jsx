...
const OtpInputItem = ({ value, onChange, onKeyDown, onFocus, error }) => {
  return (
    <input
      type="text"
      inputMode="numeric"
    ...
    >
      ...
      >
        ...
        <div style={{ textAlign: "center" }}>
          <AuthHeading>Verify your number</AuthHeading>
          <AuthText>
            Enter the one-time password (OTP) sent to <br />
            +91-{phone}.{" "}
            <span
              onClick={onBack}
              style={{ color: "#4c2399", cursor: "pointer" }}
            >
              Change Phone number
            </span>
          </AuthText>
        ...
        <div style={{ fontSize: "14px" }}>
          {timeLeft > 0 ? (
            <>
              Resend Code in{" "}
              <span style={{ color: "#4c2399" }}>{timeLeft}s</span>
            </>
          ) : (
            <span
