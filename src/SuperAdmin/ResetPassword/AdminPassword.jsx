...
const AdminPassword = ({
  ...
  const getSegmentColor = (index, currentStrength) => {
    ...
    if (index < currentStrength) return "#16A34A"; // Green
    if (index === currentStrength && currentStrength < 4) return "#DC2626"; // Red for next step
    return "#E5E7EB";
  };
    ...
    <div style={{ width: "400px", margin: "0 auto", padding: "0" }}>
      <div style={{ width: "100%", display: "flex", flexDirection: "column", gap: "24px" }}>
        ...
        <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: "8px" }}>
          ...
          <AuthText>Create a strong and unique password to get started</AuthText>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            <div style={{ display: "flex", gap: "4px", width: "100%", marginTop: "4px" }}>
              {[0, 1, 2, 3].map((index) => (
                <div key={index} style={{ flex: 1, height: "4px", borderRadius: "2px", backgroundColor: getSegmentColor(index, strength), transition: "background-color 0.3s ease" }} />
              ))}
            </div>
            <p style={{ color: !!passwordError ? "#DC2626" : "#6B7280", fontFamily: "Inter", fontSize: "12px", marginTop: "4px", lineHeight: "1.5" }}>
              Password must be at least 8 characters, with 1 uppercase, 1 lowercase, 1 digit and 1 special character
            </p>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
            ...
            />
            {confirmError && <p style={{ color: "#DC2626", fontFamily: "Inter", fontSize: "12px", marginTop: "4px" }}>{confirmError}</p>}
          </div>
