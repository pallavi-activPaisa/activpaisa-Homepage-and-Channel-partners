...
const Footer = () => {
  return (
    ...
    >
      <footer className="footer-main w-[1440px] ">
        ...
        <div className="footer-notices">
          <p>
            ...
            such incidents immediately at care@activpaisa.com or +91 97739
            79796.
          </p>
          ...
          <p>
            For issues related to digital lending, write to care@activpaisa.com
            or call +91 97739 79796. If your concern is not resolved within the
