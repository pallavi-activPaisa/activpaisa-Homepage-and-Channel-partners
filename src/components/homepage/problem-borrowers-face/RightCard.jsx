...
const RightCard = () => {
  return (
    <div
      className="w-[600px] h-[420px]  flex flex-col items-center justify-center "
      style={{
        padding: "65px 48px",
    ...
    >
      ...
      {/* description */}
      <div
        className="w-full h-[48px] mt-[8px] flex justify-center items-center  text-center"
        style={{
      ...
      >
        ActivPaisa helps you borrow without the delays, confusion, or hidden
        surprises.
      </div>
    </div>
  );
