...
const AuthButton = ({ children, style, disabled, ...props }) => {
    ...
    // Define base colors
    const disabledBg = "var(--ui-color-state-disabled-dis-neutral-light-30, #f3f4f6)";
    ...
    const disabledText = "var(--ui-color-state-on-disabled-neutral-light-30-on-dis-neutral-light-30-n10, #d1d5db)";
    const activeText = "#ffffff";

    const currentBg = disabled ? disabledBg : (isHovered ? activeHoverBg : activeBg);
    ...
    return (
        <button
            ...
            style={{
                ...
                boxShadow:
                    disabled ? "none" : "0 calc(1 * 1px) calc(2 * 1px) rgba(17, 24, 39, 0.04)",
        ...
        >
            <span
                style={{
                    ...
                    fontSize:
                        "calc(var(--typogrraphy-label-l-1-size, 16) * 1px)",
                    fontWeight: 500,
                    lineHeight:
